...
import { GrantSigningError, requestAndSignGrant } from "@/lib/grant-signing";
...
export default function AutonomyScreen() {
	...
	async function issueGrant() {
		...
		try {
			...
			const m =
				err instanceof GrantSigningError ? `${err.code}: ${err.message}` : (err as Error).message;
