...
export function GoldSeal({
	...
	size = 24,
	className,
}: GoldSealProps): React.JSX.Element {
	return (
		<span
			role="img"
			aria-label={label}
		...
		>
			<span
				...
				style={{
					background: "conic-gradient(from 30deg, #C9A36A, #F1D9A3, #A07E48, #C9A36A)",
					padding: 1,
			...
			<span
				...
				style={{
					width: size * 0.34,
					height: size * 0.34,
					background: "radial-gradient(circle, #F1D9A3 0%, #C9A36A 60%, #A07E48 100%)",
