...
const PANEL_CLS =
	"relative isolate overflow-hidden flex flex-col items-center gap-5 px-8 py-10 text-center";
	...
	return (
		<span
			...
			style={{
				...
				height: size,
				background:
					"conic-gradient(from 0deg, transparent 0deg, transparent 270deg, var(--color-copper) 360deg)",
...
export function LoadingState({
	...
	return (
		...
		>
			<AmbientGlow
				tone="sky"
				className="!inset-[-40%_-30%_auto_-30%] !w-[160%] !h-[80%] opacity-50"
			/>
...
export function ErrorState({
	...
	return (
		<GlassPanel
			...
			aria-live="assertive"
			aria-labelledby={headingId}
			className={cn(PANEL_CLS, "border-[var(--color-copper)]/40", className)}
			style={{ borderColor: "rgba(201,163,106,0.36)" }}
		>
			<AmbientGlow
				tone="copper"
				className="!inset-[-30%_-20%_auto_-20%] !w-[140%] !h-[80%] opacity-50"
			/>
