    ...
    >
      <div className="flex items-start justify-between gap-6">
        <div>
          ...
          <div className="mt-2 text-[length:var(--text-body)] text-pearl-soft">
            {detail}
          </div>
        </div>
        <StatusPill tone={tone} size="md">{action}</StatusPill>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        <div>
          ...
          <div className="font-display text-[length:var(--text-h2)] tabular-nums text-pearl">
            {speed.toFixed(1)} <span className="text-[length:var(--text-body)] text-pearl-soft">kph</span>
          </div>
        </div>
        <div>
          <div className="luxe-mono text-[length:var(--text-micro)] uppercase tracking-[var(--tracking-caps)] text-pearl-muted">
          ...
          {next ? (
            <div>
              <div className="font-display text-[length:var(--text-h3)] text-pearl">{next.label}</div>
            ...
            <div className="font-display text-[length:var(--text-h3)] text-pearl-soft">— clear —</div>
          )}
        </div>
        <div>
          <div className="luxe-mono text-[length:var(--text-micro)] uppercase tracking-[var(--tracking-caps)] text-pearl-muted">
          ...
          <div className="font-display text-[length:var(--text-h2)] tabular-nums text-pearl">
            {traveled.toFixed(2)}<span className="text-[length:var(--text-body)] text-pearl-soft"> / {total.toFixed(1)} km</span>
          </div>
