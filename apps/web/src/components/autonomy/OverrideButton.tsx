		...
		<>
			<button
				...
				style={{
					...
					boxShadow:
						"inset 0 0 24px rgba(201, 163, 106, 0.18), 0 12px 28px -16px rgba(201, 163, 106, 0.45)",
				}}
			>
				<span
					aria-hidden="true"
			...
			<Dialog open={open} onOpenChange={setOpen}>
				<DialogContent>
					...
					<DialogDescription>
						The vehicle returns to manual control on the next heartbeat. The revocation is written
						to the witness chain and cannot be undone.
					</DialogDescription>
					{canonicalBytesPreview ? (
						<GlassPanel variant="muted" className="mt-6 max-h-[180px] overflow-auto !p-4">
