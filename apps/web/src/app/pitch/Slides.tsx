...
function CoverSlide() {
	return (
		<div className="pitch-cover">
			<div>
				<div
					className="pitch-reveal pitch-eyebrow"
				...
				<p className="pitch-reveal pitch-cover-tagline">
					Your vehicle. Booked, diagnosed, driven, paid, and returned.
					Autonomously, audited, on a slow phone in Hindi.
				</p>
				<div
...
function HookSlide() {
	return (
		<div className="pitch-hook">
			<div className="pitch-reveal pitch-eyebrow">
				What VSBS is, in one breath.
			</div>
			<h2 className="pitch-reveal pitch-hook-line">
				...
				itself there, pays within a{" "}
				<span className="pitch-copper">cryptographically signed</span> cap, and{" "}
				<em
					style={{ fontVariationSettings: '"opsz" 144, "SOFT" 100, "WONK" 1' }}
				>
					drives home
			...
			<p className="pitch-reveal pitch-hook-secondary">
				On a slow phone, in Hindi. With zero fabricated capability — outside
				Tier-A AVP, the system gracefully degrades to a human pickup with the
				same UX. Honest about what the vehicle can and cannot do.
			</p>
			<div
				className="pitch-reveal"
		...
		>
			...
			<div className="pitch-three-col">
				{cards.map((c) => (
					<div
						key={c.kicker}
						className="pitch-reveal pitch-card pitch-card-hairline"
					>
						...
						<h3
							...
							style={{ fontSize: "1.9rem", marginBottom: 14 }}
						>
							{c.title}
						</h3>
						<p
			...
			>
				Sources: docs/research/autonomy.md:11 · docs/research/agentic.md:31 ·
				NOTICE adopter-channel framing.
			</p>
		</div>
	);
}
	...
	return (
		...
		>
			...
			<div className="pitch-reveal pitch-card" style={{ marginTop: 12 }}>
				...
				>
					"Autonomous service is the narrowest, highest-value AV wedge —
					low-speed, geofenced, owner-consented. Tractable without L5."
				</p>
				<div className="pitch-quote-attribution">
					VSBS thesis · docs/research/autonomy.md
				</div>
			</div>
		</div>
	);
	...
	return (
		...
		>
			...
			>
				...
				>
					A 12-package monorepo that is <em>safe by construction</em>, not by
					review.
				</h2>
				<p
					className="pitch-pearl-soft"
					style={{ fontSize: 16, lineHeight: 1.7, maxWidth: "44ch" }}
				>
					LangGraph supervisor with a Haiku verifier on every tool call.
					Provider-agnostic LLM layer (sim, demo, prod via one env var).
					Deterministic safety + wellbeing engines. Sensor-fusion + PHM advisory
					pipeline. CommandGrant capability protocol with passkey + ML-DSA-65
					witness. A full DPDP / GDPR / EU AI Act compliance pack. Running
					end-to-end on a slow phone, in Hindi, with zero API keys.
				</p>
			</div>
			<div className="pitch-reveal">
		...
		>
			<div className="pitch-reveal">
				...
				>
					...
					into /book step 5. Watch the SSE trace render the agent loop in plain
					English. The C3 output filter rewrites the LLM&apos;s drive-suggestion
					before any byte reaches the customer.
				</p>
				<div
					style={{
						display: "flex",
				...
				>
					...
					<div className="pitch-pearl-soft">
						docs/verification/REPORT.md:140-156
					</div>
					<div className="pitch-pearl-soft">
						runs/2026-05-02-recordings/concierge-sse.log
					</div>
					<div
						className="pitch-pearl-faint"
			...
			<div className="pitch-reveal pitch-terminal">
				<div className="pitch-terminal-header">
					...
					<span className="pitch-terminal-dot" />
					<span className="pitch-terminal-dot" />
					<span className="pitch-terminal-title">
						POST /v1/concierge/turn · text/event-stream
					</span>
				</div>
				<div className="pitch-terminal-body">
					<div className="pitch-term-line">
						...
						<span>
							<span className="pitch-term-tag pitch-term-tag--copper">
								tool
							</span>
							assessSafety(owner: &quot;grinding when I brake&quot;,
							sensorFlags: [])
						</span>
					</div>
					<div className="pitch-term-line" style={{ marginLeft: 32 }}>
						...
						<span className="pitch-pearl-soft">
							grounded · severity=green · confidence=1.0
						</span>
					</div>
					<div className="pitch-term-line">
						<span className="pitch-term-prompt">›</span>
					...
					<div className="pitch-term-line">
						<span
							className="pitch-term-prompt"
							style={{ color: "var(--color-copper)" }}
						>
							!
						</span>
						<span>
							<span className="pitch-term-tag pitch-term-tag--crit">
								C3 override
							</span>
					...
					<div className="pitch-term-line pitch-term-override">
						...
						<span>
							...
							<span style={{ fontStyle: "italic" }}>
								&quot;I cannot certify safety. Please consult a qualified
								mechanic.&quot;
							</span>
						</span>
					</div>
			...
			>
				<div>
					<div className="pitch-eyebrow">
						If we drew one diagram, it would be this.
					</div>
					<h2
						className="pitch-display"
	...
	return (
		...
		>
			...
			<desc id="arch-svg-desc">
				Top band of safety invariants over a left rail of four package layers
				(shared, sensors, llm, agents), a centre pipeline from owner through
				web, API, LangGraph, tools to a live booking, a right rail showing
				LiveAutonomyHub feeding fourteen telemetry blocks, and a bottom band
			...
			<g>
				...
				<text x="64" y="64" className="arch-label">
					Red-flag set · UNECE R157 4-rung ladder · MRM ≤ 4 m/s² · CommandGrant
					signed + geofenced + capped · PHM SOTIF gate · ISO 13374
				</text>
			</g>
			...
			<g>
				...
				<text
					x="64"
					y="450"
					className="arch-kicker"
					style={{ fill: "rgba(242,238,230,0.45)" }}
				>
...
function AgentLoopSlide() {
	...
	return (
		...
		>
			...
			>
				<div className="pitch-eyebrow">
					The agent loop, deterministic at the edges.
				</div>
				<h2
					className="pitch-display"
					style={{
				...
				<div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
					<div>
						<div
							className="pitch-eyebrow pitch-eyebrow--muted"
						...
						<div
							className="pitch-mono"
							style={{ fontSize: 14, color: "var(--color-pearl)" }}
						>
					...
					<div>
						...
						>
							Concierge · Intake · Diagnosis · Dispatch · Wellbeing · Verifier ·
							Autonomy · Payment
						</div>
					</div>
					<div>
						...
						<div
							...
							style={{ fontSize: 13, lineHeight: 1.7 }}
						>
							Confidence gate → SafetyFence → screenFinalOutput · any internal
							error fails closed to canonical red-flag advisory.
						</div>
					</div>
				</div>
			</div>
		...
		>
			...
			<div className="pitch-reveal pitch-three-col">
				<div className="pitch-card pitch-card-hairline">
					...
					>
						10 owner-reported + 4 sensor-derived. Non-overridable Set. Any hit ⇒
						severity:red, tow mandated, all drive-in / autonomous paths
						disabled.
					</div>
					<div
				...
				<div className="pitch-card pitch-card-hairline">
					...
					>
						...
						>
							<span
								className="pitch-mono"
								style={{ color: "var(--color-emerald)", fontSize: 12 }}
							>
								1
							</span>
							<div>
						...
						>
							<span
								className="pitch-mono"
								style={{ color: "#f4cf78", fontSize: 12 }}
							>
								2
							</span>
							<div>
						...
						>
							<span
								className="pitch-mono"
								style={{ color: "#f0a05c", fontSize: 12 }}
							>
								3
							</span>
							<div>
						...
						>
							<span
								className="pitch-mono"
								style={{ color: "#ef8b97", fontSize: 12 }}
							>
								4
							</span>
							<div>
				...
				<div className="pitch-card pitch-card-hairline">
					...
					<div
						...
						style={{ fontSize: 13, lineHeight: 1.6, marginBottom: 16 }}
					>
						UUID + tier + scopes + notBefore + notAfter + geofence radius +
						maxAutoPayInr + ownerSig + witnesses. Auto-pay cap encoded inside
						the signed token. The phone is the root of trust.
					</div>
			...
			>
				...
				>
					...
					per ISO 21448. Lower-confidence-bound RUL. Coverage manifest pre-check
					refuses the path before the LLM ever gets the question.
				</div>
			</div>
		</div>
	);
	...
	return (
		...
		>
			...
			>
				<div>
					<div className="pitch-eyebrow">
						Live L5 telemetry · 10 Hz · per booking.
					</div>
					<h2
						className="pitch-display"
						style={{ fontSize: "clamp(2rem, 3.8vw, 3rem)", marginTop: 12 }}
			...
			>
				Every sample is stamped with origin: &quot;real&quot; | &quot;sim&quot;.
				Branded TS types make a sim sample structurally incapable of entering a
				real decision log. The dashboard renders 12 sections, including a
				96-cell HV pack heat-map and a BEV occupancy mini-map with class-coded
				risk halos.
			</div>
		</div>
	);
	...
	return (
		...
		>
			...
			<div className="pitch-reveal pitch-numbers-grid">
				{cells.map((c) => (
					<div key={c.label} className="pitch-number-cell">
						<div
							className={`pitch-number-value${c.small ? " pitch-number-value--small" : ""}`}
						>
							{c.value}
						</div>
						<div className="pitch-number-label">{c.label}</div>
			...
			>
				...
				<span className="pitch-tag pitch-tag--emerald">
					37/37 fast-check property
				</span>
				<span className="pitch-tag pitch-tag--emerald">26-27/27 chaos</span>
				<span className="pitch-tag pitch-tag--emerald">
					19/21 Playwright Chromium
				</span>
...
function ResearchSlide() {
	...
	return (
		...
		>
			<div className="pitch-reveal">
				<div className="pitch-eyebrow">
					Research pedigree as architecture, not afterthought.
				</div>
				<h2
					className="pitch-display"
					style={{
				...
				>
					Plus the 2026-04-15 addendum capturing April 2026 deltas. A copycat
					must redo the citation work and the build.
				</div>
			</div>
			...
			>
				...
				>
					35 USC §102 · EPC Art. 54 · Indian Patents Act §13. A copycat cannot
					patent around them.
				</div>
			</div>
		</div>
...
function ComplianceSlide() {
	...
	return (
		...
		>
			<div className="pitch-reveal">
				<div className="pitch-eyebrow">
					Compliance from line one. Not retrofitted.
				</div>
				<h2
					className="pitch-display"
					style={{ fontSize: "clamp(2rem, 3.8vw, 3rem)", marginTop: 12 }}
			...
			>
				Compliance pack lives at docs/compliance/ · 10 artefacts · DPIA · FRIA ·
				18-row AI risk register · CCPA-CPRA overlay · jurisdiction matrix ·
				retention schedule · breach runbook · consent notices index.
			</div>
		</div>
	);
}
...
function PhasesSlide() {
	const phases: { id: string; name: string; detail: string }[] = [
		...
		},
		{
			...
			detail:
				"AlloyDB + pgvector · GraphRAG · BGE-M3 · DTC corpus · ISO 2575 · Indic NLP.",
		},
		{
			id: "P4",
			name: "Dual-region IN + US",
			detail:
				"Cloud Run × 2 · Firestore residency · Cloud Armor · DNSSEC · region router.",
		},
		{
			id: "P5",
		...
		},
		{
			...
			name: "Observability",
			detail:
				"OTel · structured JSON logs · metrics · SIEM SSE feed · SLO burn-rate · runbooks.",
		},
		{
			id: "P8",
		...
		},
		{
			...
			name: "Admin console",
			detail:
				"Operator queue · capacity heat-map · pricing · SLA · audit Merkle viewer.",
		},
		{
			id: "P11",
			name: "Quality + verification",
			detail:
				"Property · chaos · agent-eval · Playwright · load · Lighthouse CI.",
		},
	];
	...
	return (
		...
		>
			...
			>
				...
				>
					B2B2C OEM partnerships, with a <em>research-pedigreed</em> reference
					architecture as the on-ramp.
				</h2>
				<p
					className="pitch-pearl-soft"
					style={{ fontSize: 15, lineHeight: 1.7, maxWidth: "44ch" }}
				>
					Apache 2.0 + NOTICE lets adopters white-label and ship closed-source —
					no royalty. The revenue thesis is paid integration, safety-case + DPIA
					/ FRIA support, OEM-specific telematics + PHM model plug-ins, and
					regional compliance engagement. India-first OEM pilot is the explicit
					Phase-12 step.
				</p>
				<div
			...
			>
				...
				{[
					{
						...
						detail:
							"Closed pilot ≤ 100 bookings · India-first · Phase 12 gate.",
					},
					{
						title: "Safety + compliance support",
						detail:
							"DPIA · FRIA · ISO 26262 / 21448 · UNECE R155-R157 dossier.",
					},
					{
						title: "Custom sensor-fusion / PHM plug-ins",
						detail:
							"OEM-specific RUL models · provenance-aware ingest · sensor calibration.",
					},
					{
					...
					},
					{
						...
						detail:
							"Academic partners · prior-art reference · standards bodies.",
					},
				].map((c) => (
					<div
						key={c.title}
					...
					>
						<div
							className="pitch-numbered-title"
				...
				>
					Inferred from NOTICE wording + Phase 12 + OEM adapter shells. No
					separate BUSINESS.md.
				</div>
			</div>
		</div>
	);
	...
	return (
		<div className="pitch-closing">
			...
			>
				...
				>
					PhD-grade work deserves a name on it. Users deserve to know who to
					thank — or challenge.
				</p>
				<div
					style={{
