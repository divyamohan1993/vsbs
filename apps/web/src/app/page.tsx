...
const KPIS = [
	{
		...
		value: "1,163",
		status: "ok" as const,
		description: "Across 13 workspaces, run on every push.",
		size: "xl" as const,
	},
	{
...
export default async function HomePage(): Promise<React.JSX.Element> {
	return (
		<div className="space-y-[80px] md:space-y-[120px]">
			<Hero
				image="hero-eqs-garage.webp"
				imagePortrait="hero-eqs-garage-portrait.webp"
				height="tall"
			>
				<div className="flex max-w-[820px] flex-col gap-8">
					<SpecLabel>Autonomous Vehicle Service</SpecLabel>
					<h1 className="font-[family-name:var(--font-display)] text-[clamp(3rem,8vw,6rem)] font-medium leading-[1.02] tracking-[var(--tracking-tight)] text-pearl">
						Your vehicle. Served.
					</h1>
					<p className="max-w-[560px] text-[length:var(--text-lg)] leading-[1.55] text-pearl-muted">
						Autonomous, audited, and on your schedule. The booking, the diagnosis, and the handover
						all in one calm motion.
					</p>
			...
			<section aria-labelledby="brief" className="mx-auto w-full max-w-[720px] text-center">
				...
				<blockquote className="mt-6">
					<p className="font-[family-name:var(--font-display)] text-[length:var(--text-h3)] italic leading-[1.35] text-pearl">
						We took the customer experience of a Maybach showroom, the engineering rigour of an
						aerospace prognostics lab, and the privacy posture of a Swiss bank, and asked: what does
						a service booking feel like?
					</p>
				...
				<div className="grid gap-6 md:grid-cols-[2fr_3fr]">
					<div className="flex flex-col gap-4">
						...
						<p className="text-[length:var(--text-control)] leading-[1.7] text-pearl-muted">
							VSBS is the work of Divya Mohan at dmj.one. Apache 2.0. The defensive publication is
							dated April 2026 and names twelve concepts whose ownership we wish to make permanent
							and free.
						</p>
					</div>
					<GlassPanel variant="muted" className="flex flex-col justify-between gap-6">
						<div className="flex flex-col gap-3">
							...
							<p className="text-[length:var(--text-body)] leading-[1.7] text-pearl">
								Every external dependency runs in a simulator that is bit-identical to the live
								driver. Every safety red-flag is hard-coded and double-checked. Every recommendation
								is auditable by you.
							</p>
						</div>
