...
// Resolve the upstream API base from server-side env first, then fall back
// to the public env (which Cloud Run guarantees is set on the web service),
// and finally local dev. This closes audit finding F9 — production must
// never silently route browser traffic to localhost.
const API_BASE =
