...
export function ConciergeRunner({
	...
	return (
		<section aria-labelledby="concierge-h" className="space-y-6">
							...
							style={{
								backgroundColor: running
									...
									: error
										? "var(--color-crimson)"
										: "var(--color-emerald)",
								boxShadow: running ? "0 0 12px rgba(79,183,255,0.55)" : "none",
							}}
						/>
...
function describe(ev: ConciergeEvent, t: ReturnType<typeof useTranslations>): RowMeta {
