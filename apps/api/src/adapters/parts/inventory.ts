...
export const SEED_PART_CATALOG: PartCatalogEntry[] = [
	...
	{
		code: "ATE-13.0460-2782.2",
		manufacturer: "ATE",
		description: "Continental ATE rear brake-pad set",
		fitsSystems: ["brakes"],
	},
	{
		code: "MGP-MFC-BR-001",
		manufacturer: "Mahindra First Choice",
		description: "Front brake-pad set (workshop SKU)",
		fitsSystems: ["brakes"],
	},
	{
		code: "BOSCH-0451103300",
		manufacturer: "Bosch",
		description: "Engine oil filter element",
		fitsSystems: ["engine-oil"],
	},
	{
		code: "KN-PS-1004",
		manufacturer: "K&N",
		description: "K&N PS-1004 oil filter",
		fitsSystems: ["engine-oil"],
	},
	{
		code: "EXIDE-MX-7",
		manufacturer: "Exide",
		description: "12V starter battery (Exide MX series)",
		fitsSystems: ["battery-12v"],
	},
	{
		code: "GATES-K060842",
		manufacturer: "Gates",
		description: "Multi-rib drive belt 6PK2138",
		fitsSystems: ["drive-belt"],
	},
	{
		code: "MERC-EQS-CELL-MOD-A1",
		manufacturer: "Mercedes-Benz",
		description: "EQS HV battery cell module — service spare",
		fitsSystems: ["battery-hv"],
	},
	{
		code: "TESLA-COOL-KIT-M3-2024",
		manufacturer: "Tesla",
		description: "Model 3 coolant flush kit (long-life HOAT)",
		fitsSystems: ["cooling"],
	},
	{
		code: "SKF-VKBA-3525",
		...
		fitsSystems: ["wheel-bearings"],
	},
	{
		code: "MRF-ZSLK-205-55-16",
		manufacturer: "MRF",
		description: "MRF ZSLK 205/55 R16 tyre",
		fitsSystems: ["tyres"],
	},
];
