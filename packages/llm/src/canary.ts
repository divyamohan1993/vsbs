...
export interface CanaryRoutingDecision {
	...
	canary?: { provider: string; modelId: string; version: string; reason: string } | undefined;
...
export function bucketFor(conversationId: string, salt = ""): number {
	...
	const n = h[0]! * 0x01000000 + h[1]! * 0x00010000 + h[2]! * 0x00000100 + h[3]!;
	return n % 100;
}
