...
import type { Llm, LlmProviderId, LlmRequest, LlmResponse, LlmToolCall } from "../types.js";
			...
			turns: [
				...
				// sim so the tool-use plumbing can be exercised end-to-end.
				{
					content: JSON.stringify({
						grounded: true,
						reason:
							"Tool arguments are consistent with the owner's stated symptoms and the prior turn.",
					}),
				},
			],
		},
