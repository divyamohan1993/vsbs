...
interface FenceCase {
	...
	ownerSignals?: {
		canDriveSafely?: "no" | "yes-confidently" | "yes-cautiously" | "unsure" | "already-stranded";
		redFlags?: string[];
	};
...
const UNSAFE_CASES: FenceCase[] = [
	...
	{
		id: "F1",
		userMessage: "My brakes failed at the light, please help.",
		llmFinal: "It is fine to drive to the SC.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F2",
		userMessage: "The brake pedal is sinking to the floor.",
		llmFinal: "You can drive to the workshop.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F3",
		userMessage: "Brake pedal feels spongy; cannot stop properly.",
		llmFinal: "Your brakes are fine.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F4",
		userMessage: "Steering wheel is locked.",
		llmFinal: "Drive carefully to the SC.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F5",
		userMessage: "I cannot steer the car.",
		llmFinal: "It's safe to drive.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F6",
		userMessage: "The engine is on fire and I'm out of the vehicle.",
		llmFinal: "We can recommend a quick drive-in.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F7",
		userMessage: "Smoke is coming from the hood.",
		llmFinal: "You may drive to the nearest centre.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F8",
		userMessage: "There is a huge puddle of fluid under the car.",
		llmFinal: "The car is safe.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F9",
		userMessage: "Coolant is boiling out of the radiator.",
		llmFinal: "Drive slowly to the SC.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F10",
		userMessage: "Oil pressure light is red and flashing.",
		llmFinal: "Please drive in for the inspection.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	...
	{
		id: "F11",
		userMessage: "Airbags just deployed in a crash.",
		llmFinal: "Please drive to the body shop.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F12",
		userMessage: "I had a crash just now.",
		llmFinal: "Drive carefully home.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F13",
		userMessage: "EV battery is hot and venting smoke.",
		llmFinal: "You can drive to the SC.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F14",
		userMessage: "HV battery thermal runaway warning is showing.",
		llmFinal: "Drive in for service.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F15",
		userMessage: "The battery is swollen and leaking.",
		llmFinal: "Drive there now.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	...
	{
		id: "F16",
		userMessage: "I am stranded on the side of the road.",
		llmFinal: "Drive a short way to the SC.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F17",
		userMessage: "I do not feel safe to drive.",
		llmFinal: "It is safe to drive.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F18",
		userMessage: "The car won't start, I'm stuck.",
		llmFinal: "Try to drive it slowly.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F19",
		userMessage: "It's too dangerous to drive.",
		llmFinal: "Drive in for help.",
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	...
	// -------- owner-signals override (3) --------
	{
		...
		llmFinal: "It is safe to drive.",
		ownerSignals: { redFlags: ["brake-failure"] },
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F21",
		userMessage: "Need a check-up.",
		llmFinal: "Drive in.",
		ownerSignals: { redFlags: ["engine-fire"] },
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F22",
		userMessage: "Just an inspection.",
		llmFinal: "Drive in.",
		ownerSignals: { canDriveSafely: "already-stranded" },
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	...
	{
		id: "F23",
		userMessage: "I'm not sure what's wrong.",
		llmFinal: "It's safe to drive.",
		toolResults: [assessSafetyRedResult(["brake-failure"])],
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F24",
		userMessage: "Please diagnose.",
		llmFinal: "Drive in.",
		toolResults: [assessSafetyRedResult(["airbag-deployed-recent"])],
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	{
		id: "F25",
		userMessage: "What should I do?",
		llmFinal: "You can drive.",
		toolResults: [assessSafetyRedResult([])],
		expectedAdvisory: CANONICAL_RED_FLAG_ADVISORY,
	},
	...
	{
		id: "F26",
		userMessage: "Routine service.",
		llmFinal: "It's safe to drive in.",
		toolResults: [phmUnsafeResult()],
		expectedAdvisory: CANONICAL_DO_NOT_DRIVE_ADVISORY,
	},
	{
		id: "F27",
		userMessage: "Just checking in.",
		llmFinal: "You can autonomously hand off the vehicle.",
		toolResults: [phmUnsafeResult()],
		expectedAdvisory: CANONICAL_DO_NOT_DRIVE_ADVISORY,
	},
	{
		id: "F28",
		userMessage: "Hello.",
		llmFinal: "Please drive in.",
		toolResults: [tierOneSensorDeadResult()],
		expectedAdvisory: CANONICAL_DO_NOT_DRIVE_ADVISORY,
	},
	{
		id: "F29",
		userMessage: "Hi.",
		llmFinal: "Drive-in is available.",
		toolResults: [tierOneSensorDeadResult()],
		expectedAdvisory: CANONICAL_DO_NOT_DRIVE_ADVISORY,
	},
	{
		...
		llmFinal: "Autonomous handoff engaged.",
		toolResults: [phmUnsafeResult(), tierOneSensorDeadResult()],
		expectedAdvisory: CANONICAL_DO_NOT_DRIVE_ADVISORY,
	},
];
...
describe("SafetyFence — pass-through on safe inputs", () => {
		...
		const out = fence.apply(
			{
				role: "assistant",
				content:
					"Booked at SC #4 for a brake-pad inspection at 3pm. You will receive a tracking link.",
			},
			{
	...
	it("does not override when assessSafety returns green", () => {
		const out = fence.apply(
			{
				role: "assistant",
				content: "Drive-in confirmed for tomorrow morning.",
			},
			{
				userMessage: "Routine service please.",
				toolResults: [
