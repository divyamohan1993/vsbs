...
export function evaluate(
	...
	const errorBudgetRemaining =
		totals.total === 0 ? 1 : Math.max(0, 1 - observedErrorRate / allowedErrorRate);
	...
	const sev: "page" | "ticket" | null =
		firing.length === 0 ? null : firing.some((t) => t.severity === "page") ? "page" : "ticket";
