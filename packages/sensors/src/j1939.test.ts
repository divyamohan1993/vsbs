		...
		const faults = [
			{
				spn: 100,
				fmi: 1,
				fmiLabel: "data-valid-but-below-normal",
				occurrenceCount: 7,
				conversionMethod: 0 as const,
			},
			{
				spn: 110,
				fmi: 0,
				fmiLabel: "data-valid-but-above-normal",
				occurrenceCount: 3,
				conversionMethod: 0 as const,
			},
			{
				spn: 168,
				fmi: 4,
				fmiLabel: "voltage-below-normal-or-short-to-low",
				occurrenceCount: 12,
				conversionMethod: 1 as const,
			},
		];
