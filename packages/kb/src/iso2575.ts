...
const ENTRIES: TellTale[] = [
	// ---- Red (severity 3): immediate-action group ----
	{
		...
		category: "warning",
		description:
			"Insufficient engine oil pressure. Stop the engine as soon as it is safe to prevent bearing damage.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Charging system not delivering current. The vehicle is running on battery only and will stall once depleted.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Critical brake-system condition: parking brake on, brake fluid low, or hydraulic fault. Stop and inspect.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Coolant temperature is at or above the safe limit. Stop the engine to prevent damage.",
	...
	},
	{
		...
		category: "warning",
		description:
			"High-voltage propulsion battery state of charge is critically low or thermally unsafe.",
	...
	},
	{
		...
		category: "warning",
		description:
			"ABS fault. Conventional braking still functions; ABS will not engage during emergency stops.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Lane keeping assistant fault, unavailable, or about to exit lane unintentionally.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Diesel exhaust fluid (AdBlue / DEF) below threshold. Engine power may be limited if not refilled.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Wait for the lamp to turn off before cranking. If staying on after start, indicates a glow plug fault.",
	...
	},
	{
		...
		category: "warning",
		description:
			"Power assist for steering is reduced or unavailable. Effort to steer will increase.",
...
export function listTellTales(filter?: {
	color?: TellTaleColor;
