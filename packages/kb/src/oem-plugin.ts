...
import { z } from "zod";
import { type KbChunk, KbChunkSchema } from "./alloydb.js";
...
const NHTSA_FIXTURE: NhtsaFixture[] = [
	{
		...
		model: "Civic",
		system: "brake",
		text: "Honda Civic 2024 brake squeal under light pedal pressure. Inspect front brake pads for glazing and resurface or replace as required. Refer to ICON_BRAKE_SYSTEM tell-tale flagged with DTC C0035 if reported.",
	},
	{
		number: "TYO-2023-018",
		oem: "Toyota",
		...
		model: "Camry",
		system: "engine",
		text: "Toyota Camry 2023 may exhibit P0420 catalyst efficiency below threshold under city driving cycles. Update engine control module to calibration revision F2 and re-run drive cycle.",
	},
	{
		number: "FRD-2022-045",
		oem: "Ford",
		...
		model: "F150",
		system: "transmission",
		text: "Ford F150 2022 10R80 transmission slipping in 3-4 upshift. Replace shift solenoid B and update transmission control module software. P0755 is the commonly reported DTC.",
	},
	{
		number: "GMT-2024-007",
		oem: "Chevrolet",
		...
		model: "Silverado",
		system: "fuel",
		text: "Chevrolet Silverado 2024 high-pressure fuel pump failure manifesting as P0087. Replace HPFP per service manual; inspect crankshaft position correlation and clear any associated P0335.",
	},
];
