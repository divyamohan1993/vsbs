...
const SYSTEM_KEYWORDS: Array<{ id: string; surfaces: string[] }> = [
	...
	{
		id: "system:hv-battery",
		surfaces: ["high voltage", "hv battery", "traction battery", "lithium-ion pack"],
	},
	{
		id: "system:hvac",
		surfaces: ["hvac", "air conditioning", "a/c", "heater"],
	},
	...
	{
		id: "system:suspension",
		surfaces: ["suspension", "shock absorber", "strut"],
	},
	{ id: "system:tpms", surfaces: ["tpms", "tyre pressure", "tire pressure"] },
	{
		id: "system:transmission",
		surfaces: ["transmission", "gearbox", "torque converter", "cvt"],
	},
