...
export const DtcSystemSchema = z.enum(["powertrain", "body", "chassis", "network"]);
...
const ENTRIES: DtcEntry[] = [
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Crankshaft / camshaft correlation bank 1 sensor A",
	},
	{
		code: "P0017",
		system: "powertrain",
		severity: "warning",
		description: "Crankshaft / camshaft correlation bank 1 sensor B",
	},
	{
		code: "P0018",
		system: "powertrain",
		severity: "warning",
		description: "Crankshaft / camshaft correlation bank 2 sensor A",
	},
	{
		code: "P0019",
		system: "powertrain",
		severity: "warning",
		description: "Crankshaft / camshaft correlation bank 2 sensor B",
	},
	{
		code: "P0020",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "A camshaft position timing over-advanced bank 2",
	},
	{
		code: "P0022",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Turbo / supercharger bypass valve control circuit",
	},
	{
		code: "P0036",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Intake air temperature sensor 2 range/performance",
	},
	{
		code: "P0097",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "MAP / barometric pressure circuit high input",
	},
	{
		code: "P0109",
		system: "powertrain",
		severity: "warning",
		description: "MAP / barometric pressure circuit intermittent",
	},
	{
		code: "P0110",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Intake air temperature sensor 1 range/performance",
	},
	{
		code: "P0112",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Intake air temperature sensor 1 intermittent",
	},
	{
		code: "P0115",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Engine coolant temperature sensor 1 range/performance",
	},
	{
		code: "P0117",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Engine coolant temperature sensor 1 intermittent",
	},
	{
		code: "P0120",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Throttle / pedal position sensor / switch A range/performance",
	},
	{
		code: "P0122",
		system: "powertrain",
		severity: "warning",
		description: "Throttle / pedal position sensor / switch A low input",
	},
	{
		code: "P0123",
		system: "powertrain",
		severity: "warning",
		description: "Throttle / pedal position sensor / switch A high input",
	},
	{
		code: "P0125",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Coolant thermostat (regulating temperature below threshold)",
	},
	{
		code: "P0130",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Fuel rail pressure sensor circuit low",
	},
	{
		code: "P0193",
		system: "powertrain",
		severity: "warning",
		description: "Fuel rail pressure sensor circuit high",
	},
	{
		code: "P0200",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Transmission fluid overtemperature condition",
	},
	{
		code: "P0219",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Turbo / supercharger boost sensor A circuit",
	},
	{
		code: "P0236",
		system: "powertrain",
		severity: "warning",
		description: "Turbo / supercharger boost sensor A range/performance",
	},
	{
		code: "P0237",
		system: "powertrain",
		severity: "warning",
		description: "Turbo / supercharger boost sensor A low",
	},
	{
		code: "P0238",
		system: "powertrain",
		severity: "warning",
		description: "Turbo / supercharger boost sensor A high",
	},
	// ---- P03xx: misfire ----
	{
		code: "P0300",
	...
	// ---- P032x-P035x: ignition ----
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Knock sensor 1 circuit bank 1 or single sensor",
	},
	{
		code: "P0326",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Camshaft position sensor A circuit range/performance bank 1",
	},
	{
		code: "P0345",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Exhaust gas recirculation control circuit",
	},
	{
		code: "P0420",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Evaporative emission control system leak detected (small)",
	},
	{
		code: "P0443",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Evaporative emission control system leak detected (very small)",
	},
	{
		code: "P0457",
		system: "powertrain",
		severity: "advisory",
		description: "Evaporative emission system leak detected (loose fuel cap)",
	},
	...
	},
	{
		...
		system: "powertrain",
		severity: "critical",
		description: "Engine oil pressure sensor / switch A low voltage",
	},
	{
		code: "P0523",
		system: "powertrain",
		severity: "critical",
		description: "Engine oil pressure sensor / switch A high voltage",
	},
	{
		code: "P0524",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Transmission range sensor circuit (PRNDL input)",
	},
	{
		code: "P0706",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Transmission fluid temperature sensor A range/performance",
	},
	{
		code: "P0712",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "Input / turbine speed sensor A circuit",
	},
	{
		code: "P0720",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "advisory",
		description: "Reverse inhibit control circuit",
	},
	{
		code: "P0810",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "critical",
		description: "Engine failed to start (HV system disabled)",
	},
	{
		code: "P0A1F",
		system: "powertrain",
	...
	},
	{
		...
		system: "powertrain",
		severity: "warning",
		description: "DC/DC converter performance",
	},
	{
		code: "P0AFA",
		system: "powertrain",
	...
	// ---- B / Body codes ----
	{
		...
		system: "body",
		severity: "critical",
		description: "Front driver airbag deployment / monitoring",
	},
	{
		code: "B0028",
		system: "body",
		severity: "critical",
		description: "Front passenger airbag deployment / monitoring",
	},
	{
		code: "B0046",
		system: "body",
		severity: "critical",
		description: "Driver seat belt pretensioner deployment",
	},
	{
		code: "B1000",
		system: "body",
	...
	},
	{
		...
		system: "body",
		severity: "warning",
		description: "ECU is defective (EEPROM)",
	},
	{
		code: "B1421",
		system: "body",
		severity: "advisory",
		description: "Outside air temperature sensor circuit failure",
	},
	{
		code: "B2477",
		system: "body",
	...
	},
	{
		...
		system: "chassis",
		severity: "critical",
		description: "ABS master cylinder pressure circuit",
	},
	{
		code: "C0161",
		system: "chassis",
	...
	},
	{
		...
		system: "chassis",
		severity: "warning",
		description: "ABS system disabled or not present",
	},
	{
		code: "C0710",
		system: "chassis",
	...
	},
	{
		...
		system: "network",
		severity: "warning",
		description: "Lost communication with instrument panel cluster module",
	},
	{
		code: "U0167",
		system: "network",
	...
	},
	{
		...
		system: "network",
		severity: "critical",
		description: "Invalid data received from ABS module",
	},
];
...
export function listDtcs(filter?: {
	system?: DtcSystem;
