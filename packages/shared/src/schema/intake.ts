...
export const LocaleSchema = z.enum(["en", "hi", "ta", "te", "bn", "mr", "gu", "kn", "ml", "pa"]);
...
export const OwnerSchema = z.object({
	...
	preferredChannel: z.enum(["app", "sms", "whatsapp", "email", "voice"]).default("app"),
...
export const IssueSchema = z.object({
	...
	frequency: z.enum(["constant", "intermittent", "once", "worsening"]).optional(),
	noise: z
		.object({
...
export const SelfSafetySchema = z.object({
	canDriveSafely: z.enum(["yes-confidently", "yes-cautiously", "unsure", "no", "already-stranded"]),
	redFlags: z
		.array(
			z.enum([
				"brake-failure",
