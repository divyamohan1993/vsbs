...
import { z } from "zod";
import { type AutonomyAction, type CommandGrant, CommandGrantSchema } from "./autonomy.js";
import { canonicalGrantBytes } from "./commandgrant-lifecycle.js";

// ---------- Policy ----------

export const DualControlRoleSchema = z.enum(["owner-passkey", "ops-witness", "regulator-witness"]);
...
export class InMemoryOffPlatformSink implements OffPlatformAuditSink {
	...
	readonly entries: Array<{
		entry: OffPlatformAuditEntry;
		receipt: OffPlatformAuditReceipt;
	}> = [];
