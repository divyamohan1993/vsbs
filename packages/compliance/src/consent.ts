...
export interface ConsentManager {
	...
	requiresReConsent(
		userId: string,
		latestVersions: Record<ConsentPurpose, string>,
...
export const DEFAULT_PURPOSE_REGISTRY: Readonly<Record<ConsentPurpose, PurposeDescriptor>> =
	Object.freeze({
		"service-fulfilment": {
		...
		"diagnostic-telemetry": {
			...
			description_hi: "हम दोष निदान के लिए वाहन से OBD-II कोड, टेलीमेट्री और सेंसर रीडिंग एकत्र करते हैं।",
			legal_basis: "consent",
			necessary: false,
			revocable: true,
		},
		...
		marketing: {
			...
			description_hi: "हम वैकल्पिक सेवा रिमाइंडर, ऑफ़र और उत्पाद अपडेट भेजते हैं। आप कभी भी ऑप्ट आउट कर सकते हैं।",
			legal_basis: "consent",
			necessary: false,
			revocable: true,
		},
...
export class ConsentNotRevocableError extends Error {
	...
	constructor(purpose: ConsentPurpose) {
		super(
			`Purpose ${purpose} is necessary for the contract and cannot be revoked while it is active.`,
		);
