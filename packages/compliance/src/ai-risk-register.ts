...
export const AI_RISK_REGISTER: ReadonlyArray<AiRiskRow> = [
	{
		...
		controls: [
			...
			"deny-list",
			"Haiku verifier on privileged tools",
		],
	...
	},
	{
		...
		controls: [
			"groundedness gate with citations",
			"dual-cross-check safety pipeline",
			"explanation drawer",
		],
	...
	},
	{
		...
		controls: [
			...
			"AutonomyCapabilityContext schema",
			"fail-closed resolver default",
		],
	...
	},
	{
		...
		controls: [
			"weekly demographic-parity monitor",
			"<= 5% disparity alert",
	...
	},
	{
		...
		controls: [
			"3-state arbitration",
			"uncertainty-aware RUL lower bound",
	...
	},
	{
		...
		controls: [
			"versioned policy resolver",
			"quarterly compliance review",
			"subscribe to gazette/EUR-Lex",
		],
...
export function registerIntegrityReport(): {
	...
	const byCategory: Record<NistCategory, number> = {
		govern: 0,
		map: 0,
		measure: 0,
		manage: 0,
